...
class QLearning:
    ...
    def choose_action(self, observation):
        ...
        best_action = np.random.choice(
            self.q_table.loc[observation, :][self.q_table.loc[observation, :] == best_action_value].index)
    ...
    def learn(self, s, a, r, s_):
        ...
        if s_ == 'terminal':
            ...
            self.q_table.loc[s, a] += self.lr * (r + self.gamma * self.q_table.loc[s_, self.actions].max() - self.q_table.loc[s, a])
